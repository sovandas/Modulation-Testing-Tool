function [BER, BER_SM, BER_QAM, channel, estimated_channel, estimated_SNR, fitted_SNR] = SM_ofdm_processing_adaptive_modulation(input_ch1, input_ch2, qam_dco_ch1, qam_dco_ch2, SM_bits, offset_ch1, offset_ch2, M, P, OFDMParameters)
    ...
    if offset+k>0
        for l=1:1:1
            if offset+l>0
                ...
                [BER, BER_SM, BER_QAM, channel, estimated_channel, estimated_SNR, fitted_SNR] = SM_test_est_with_ch_est_adaptive_modulation(input_downsampled_ch1, input_downsampled_ch2, qam_dco_ch1, qam_dco_ch2, SM_bits, M, P, OFDMParameters.frames, OFDMParameters.Nfft, ...
            ...
            OFDMParameters.samples_per_symbol, OFDMParameters.filter_type, OFDMParameters.roll_off_factor, max(M), OFDMParameters.number_of_pilot_frames);
                close all;
                sum(BER)/length(BER)

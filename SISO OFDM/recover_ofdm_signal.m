function [result] = recover_ofdm_signal(input, offset_position, filter_type, roll_off_factor, Frames, Nfft, CP, samples_per_symbol)
...
if filter_type==0 %This is the case without pulse shaping
    ...
    result = ofdm_demodulate_real(dco_ofdm_pilot_distorted,Nfft,CP); %Demodulate the downsampled OFDM signal
...
if filter_type==2 %This is the case with a square pulse 
    ...
    result = ofdm_demodulate_real(dco_ofdm_pilot_distorted2,Nfft,CP); %Demodulate the downsampled OFDM signal

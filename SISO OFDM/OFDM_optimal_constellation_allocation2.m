function [allocated_constellations, energy_per_active_carrier] = OFDM_optimal_constellation_allocation2(M_max, Nfft, omitted_carriers, BER_target, available_SNR)
...
energy_per_active_carrier = (Nfft-2)/2/sum(energy_per_active_carrier).*energy_per_active_carrier;
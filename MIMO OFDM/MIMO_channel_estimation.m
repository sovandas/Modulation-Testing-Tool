function [channel3, estimated_channel3, SNR5, SNR6] = MIMO_channel_estimation(input_from_diode, qam_dco, Frames, Nfft, cp_length, omitted_carriers, preamble_length, offset, samples_per_symbol, filter_type, roll_off_factor)

qam_recovered_diode = MIMO_recover_ofdm_signal(input_from_diode, preamble_length+offset, filter_type, roll_off_factor, Frames, Nfft, cp_length, samples_per_symbol);
